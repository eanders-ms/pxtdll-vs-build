...
struct VMImageSectionAndData : VMImageSection {
    uint8_t data[0];
};

static inline VMImageSectionAndData * vmNextSection(VMImageSection *sect) {
    return (VMImageSectionAndData *)((uint8_t *)sect + sect->size);
}
...
struct VMImage {
    ...
    VMImageSectionAndData **sections;
