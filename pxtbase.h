...
#ifdef _MSC_VER
#define PACKED(CLASS_DECL) __pragma( pack(push, 1) ) CLASS_DECL __pragma( pack(pop))
#elif defined(__GNUC__)
#define PACKED(CLASS_DECL) CLASS_DECL __attribute__((__packed__))
#endif
...
PACKED(class BoxedNumber : public RefObject {
  public:
    NUMBER num;
