...
static const char ALIGNED(4) emptyBuffer[] = "@PXT#:\x00\x00\x00";
...
int * WEAK getBootloaderConfigData();
...
//WEAK int redirectSamples(int16_t *dst, int numsamples, int samplerate) {
//    return 0;
//}
